...
OR REPLACE VIEW scm.v_store(
 ...
 SELECT
  ...
  COALESCE(m_store_general_purpose.code,m_common_code_master.name_1::varchar(50)) code
 FROM
  (scm.w_store left outer join scm.m_store_general_purpose on m_store_general_purpose.general_purpose_type = 'time_zone' AND w_store.store_code = m_store_general_purpose.store_code)
  left outer join scm.m_common_code_master on m_common_code_master.type_id = 'country_time_zone' AND w_store.system_country_code = m_common_code_master.type_value
)
;
